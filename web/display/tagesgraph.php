...
<body>
	<div style="height:440px;" id="dailydiv">
	</div>
	...
	<script>
		var lastmanagements2 = <?php echo $mySettings->getSetting('lastmanagements2'); ?>;
		var lastmanagement = <?php echo $mySettings->getSetting('lastmanagement'); ?>;
		var soc1vorhanden = <?php echo $myRamdisk->getData('soc1vorhanden'); ?>;
		var speichervorhanden = <?php echo $myRamdisk->getData('speichervorhanden'); ?>;
		var graphinteractiveam = <?php echo $mySettings->getSetting('graphinteractiveam'); ?>;
		var verbraucher1vorhanden = <?php echo $myRamdisk->getData('verbraucher1vorhanden'); ?>;
		var verbraucher1name = "<?php echo $mySettings->getSetting('verbraucher1_name'); ?> (I)";
		var verbrauchere1name = "<?php echo $mySettings->getSetting('verbraucher1_name'); ?> (E)";
		var verbraucher2vorhanden = <?php echo $myRamdisk->getData('verbraucher2vorhanden'); ?>;
		var verbraucher2name = "<?php echo $mySettings->getSetting('verbraucher2_name'); ?> (I)";
		var verbrauchere2name = "<?php echo $mySettings->getSetting('verbraucher2_name'); ?> (E)";
		var verbraucher3vorhanden = <?php echo $myRamdisk->getData('verbraucher3vorhanden'); ?>;
		var verbraucher3name = "<?php echo $mySettings->getSetting('verbraucher3_name'); ?>";
		...
		if (soc1vorhanden == 1) {
			...
			//series10.tensionX = 0.8;
			//series10.tensionY = 0.8;
