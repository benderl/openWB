...
if ($myRamdisk->getData('verbraucher1vorhanden') == 1) {
	$myData->addPoints($myRamdisk->getData('verbraucher1-live.graph'),$myRamdisk->getData('verbraucher1_name'));
	$myData->setSerieOnAxis($myRamdisk->getData('verbraucher1_name'),0);
	$myData->setPalette($myRamdisk->getData('verbraucher1_name'),array("R"=>255,"G"=>202,"B"=>0));

}
if ($myRamdisk->getData('verbraucher2vorhanden') == 1) {
	$myData->addPoints($myRamdisk->getData('verbraucher2-live.graph'),$myRamdisk->getData('verbraucher2_name'));
	$myData->setSerieOnAxis($myRamdisk->getData('verbraucher2_name'),0);
	$myData->setPalette($myRamdisk->getData('verbraucher2_name'),array("R"=>255,"G"=>0,"B"=>230));
